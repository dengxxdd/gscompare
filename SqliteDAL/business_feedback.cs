	...
	public partial class business_feedback:Ibusiness_feedback
	{
		...
		public DXD.Model.business_feedback GetModel(int id)
		{
			...
			strSql.Append("select id,query_id,bus_name,scope,reg_no,bus_type,reg_capital,subscribe,proportion," +
                "status,paid_in,found_date,lost_date,office,remark,is_hidden,is_match,add_user,add_time " +
		...
		public DXD.Model.business_feedback DataRowToModel(DataRow row)
		{
			...
			if (row != null)
			{
                ...
                {
                    model.is_hidden = Boolean.Parse(row["is_hidden"].ToString());
                }
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append("select id,query_id,full_name,bus_name,bus_type,subscribe,proportion," +
                "office,status,is_match ");
			strSql.Append(" FROM vGetBusinessFeedback ");
			if(strWhere.Trim()!="")
			{
