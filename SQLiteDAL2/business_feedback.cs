...
{
	/// <summary>
	/// 数据访问类:business_feedback
	/// </summary>
	public partial class business_feedback:Ibusiness_feedback
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQLite.GetMaxID("id", "business_feedback"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from business_feedback");
		...
		public int Add(DXD.Model.business_feedback model)
		{
			...
			strSql.Append("query_id,bus_name,scope,reg_no,bus_type,reg_capital,subscribe,proportion,status,paid_in,found_date,lost_date,office,remark,add_user,add_time)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DXD.Model.business_feedback model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from business_feedback ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.business_feedback GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,query_id,bus_name,scope,reg_no,bus_type,reg_capital,subscribe,proportion,status,paid_in,found_date,lost_date,office,remark,add_user,add_time from business_feedback ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
			...
			DXD.Model.business_feedback model=new DXD.Model.business_feedback();
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.business_feedback DataRowToModel(DataRow row)
		{
			DXD.Model.business_feedback model=new DXD.Model.business_feedback();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,query_id,bus_name,scope,reg_no,bus_type,reg_capital,subscribe,proportion,status,paid_in,found_date,lost_date,office,remark,add_user,add_time ");
			strSql.Append(" FROM business_feedback ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from business_feedback T ");
