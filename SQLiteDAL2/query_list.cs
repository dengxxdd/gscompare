...
namespace DXD.SQLiteDAL
{
	...
	public partial class query_list:Iquery_list
	{
		...
		public DXD.Model.query_list GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,query_title,batch,client,entrust_date,add_user,add_time from query_list ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,query_title,batch,client,entrust_date,add_user,add_time ");
			strSql.Append(" FROM query_list ");
			if(strWhere.Trim()!="")
			{
