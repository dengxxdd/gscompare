...
{
	/// <summary>
	/// 数据访问类:security_feedback
	/// </summary>
	public partial class security_feedback:Isecurity_feedback
	{
		public security_feedback()
		{}
		#region  BasicMethod
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from security_feedback");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DXD.Model.security_feedback model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into security_feedback(");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from security_feedback ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.security_feedback GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,query_id,query_date,sec_type,sec_account,sec_code,sec_name,sec_number,sec_value,add_user,add_time from security_feedback ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
			...
			DXD.Model.security_feedback model=new DXD.Model.security_feedback();
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.security_feedback DataRowToModel(DataRow row)
		{
			DXD.Model.security_feedback model=new DXD.Model.security_feedback();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM security_feedback ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from security_feedback T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "security_feedback";
