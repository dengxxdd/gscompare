...
namespace DXD.SQLiteDAL
{
	...
	public partial class code_detail:Icode_detail
	{
		...
		public int Add(DXD.Model.code_detail model)
		{
			...
			strSql.Append("list_id,code_name,add_user,add_time)");
		...
		public DXD.Model.code_detail GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,list_id,code_name,add_user,add_time from code_detail ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,list_id,code_name,add_user,add_time ");
