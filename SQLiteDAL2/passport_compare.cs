...
{
	/// <summary>
	/// 数据访问类:passport_compare
	/// </summary>
	public partial class passport_compare:Ipassport_compare
	{
		public passport_compare()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQLite.GetMaxID("id", "passport_compare"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from passport_compare");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DXD.Model.passport_compare model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into passport_compare(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DXD.Model.passport_compare model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update passport_compare set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from passport_compare ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.passport_compare GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,query_id,feedback_id,report_id,compare_type,add_user,add_time from passport_compare ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
			...
			DXD.Model.passport_compare model=new DXD.Model.passport_compare();
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.passport_compare DataRowToModel(DataRow row)
		{
			DXD.Model.passport_compare model=new DXD.Model.passport_compare();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM passport_compare ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from passport_compare T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "passport_compare";
