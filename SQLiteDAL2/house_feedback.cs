...
{
	/// <summary>
	/// 数据访问类:house_feedback
	/// </summary>
	public partial class house_feedback:Ihouse_feedback
	{
		public house_feedback()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQLite.GetMaxID("id", "house_feedback"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from house_feedback");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DXD.Model.house_feedback model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update house_feedback set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from house_feedback ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.house_feedback GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,query_id,city,address,area,use_for,reg_time,add_user,add_time from house_feedback ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
			...
			DXD.Model.house_feedback model=new DXD.Model.house_feedback();
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.house_feedback DataRowToModel(DataRow row)
		{
			DXD.Model.house_feedback model=new DXD.Model.house_feedback();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM house_feedback ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from house_feedback T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "house_feedback";
