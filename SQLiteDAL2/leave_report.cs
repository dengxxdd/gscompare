...
namespace DXD.SQLiteDAL
{
	...
	/// 数据访问类:leave_report
	/// </summary>
	public partial class leave_report:Ileave_report
	{
		public leave_report()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQLite.GetMaxID("id", "leave_report"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from leave_report");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DXD.Model.leave_report model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into leave_report(");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from leave_report ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.leave_report GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,query_id,passport_id,passport_type,inout_type,visa_type,inout_date,port_name,destination,leave_reason,add_user,add_time from leave_report ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
			...
			DXD.Model.leave_report model=new DXD.Model.leave_report();
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.leave_report DataRowToModel(DataRow row)
		{
			DXD.Model.leave_report model=new DXD.Model.leave_report();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM leave_report ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from leave_report T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "leave_report";
