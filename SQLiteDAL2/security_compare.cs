...
{
	/// <summary>
	/// 数据访问类:security_compare
	/// </summary>
	public partial class security_compare:Isecurity_compare
	{
		public security_compare()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQLite.GetMaxID("id", "security_compare"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from security_compare");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DXD.Model.security_compare model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update security_compare set ");
			...
			strSql.Append("less_number=@less_number,");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from security_compare ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.security_compare GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,query_id,feedback_id,report_id,compare_type,less_number,less_value,add_user,add_time from security_compare ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
			...
			DXD.Model.security_compare model=new DXD.Model.security_compare();
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.security_compare DataRowToModel(DataRow row)
		{
			DXD.Model.security_compare model=new DXD.Model.security_compare();
			if (row != null)
			{
				...
				if(row["less_number"]!=null && row["less_number"].ToString()!="")
				{
					model.less_number=decimal.Parse(row["less_number"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,query_id,feedback_id,report_id,compare_type,less_number,less_value,add_user,add_time ");
			strSql.Append(" FROM security_compare ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from security_compare T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "security_compare";
