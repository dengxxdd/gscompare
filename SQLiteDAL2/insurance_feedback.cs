...
{
	/// <summary>
	/// 数据访问类:insurance_feedback
	/// </summary>
	public partial class insurance_feedback:Iinsurance_feedback
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQLite.GetMaxID("id", "insurance_feedback"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from insurance_feedback");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DXD.Model.insurance_feedback model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into insurance_feedback(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DXD.Model.insurance_feedback model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update insurance_feedback set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from insurance_feedback ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.insurance_feedback GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,query_id,query_date,ins_name,ins_no,ins_company,ins_value,remark,add_user,add_time from insurance_feedback ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
			...
			DXD.Model.insurance_feedback model=new DXD.Model.insurance_feedback();
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.insurance_feedback DataRowToModel(DataRow row)
		{
			DXD.Model.insurance_feedback model=new DXD.Model.insurance_feedback();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM insurance_feedback ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from insurance_feedback T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "insurance_feedback";
