...
namespace DXD.SQLiteDAL
{
	...
	public partial class business_report:Ibusiness_report
	{
		...
		public DXD.Model.business_report GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,query_id,bus_name,scope,reg_no,bus_type,reg_capital,subscribe,proportion,status,paid_in,found_date,lost_date,office,remark,add_user,add_time from business_report ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM business_report ");
			if(strWhere.Trim()!="")
			{
