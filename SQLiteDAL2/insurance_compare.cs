...
{
	/// <summary>
	/// 数据访问类:insurance_compare
	/// </summary>
	public partial class insurance_compare:Iinsurance_compare
	{
		public insurance_compare()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQLite.GetMaxID("id", "insurance_compare"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from insurance_compare");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from insurance_compare ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,query_id,feedback_id,report_id,compare_type,less_value,add_user,add_time ");
			strSql.Append(" FROM insurance_compare ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "insurance_compare";
