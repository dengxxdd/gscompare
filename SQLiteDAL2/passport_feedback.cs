...
{
	/// <summary>
	/// 数据访问类:passport_feedback
	/// </summary>
	public partial class passport_feedback:Ipassport_feedback
	{
		public passport_feedback()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQLite.GetMaxID("id", "passport_feedback"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from passport_feedback");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(DXD.Model.passport_feedback model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into passport_feedback(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(DXD.Model.passport_feedback model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update passport_feedback set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from passport_feedback ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.passport_feedback GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,query_id,passpport_no,passport_type,approva_auth,issuing_date,valid_date,add_user,add_time from passport_feedback ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
			...
			DXD.Model.passport_feedback model=new DXD.Model.passport_feedback();
		...
		/// 得到一个对象实体
		/// </summary>
		public DXD.Model.passport_feedback DataRowToModel(DataRow row)
		{
			DXD.Model.passport_feedback model=new DXD.Model.passport_feedback();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM passport_feedback ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from passport_feedback T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "passport_feedback";
